for i = 1, 100 do data:extend({{type = "ammo-category", name = "ammo-" .. i}}) end

data:extend({
	-- damage-type
	{type = "damage-type", name = "damage-player"}, {type = "damage-type", name = "damage-enemy"}, -- ammo-category
	{type = "ammo-category", name = "ammo-enemy"}, {type = "ammo-category", name = "rf_robot"}, -- item-group
	{
		type = "item-group",
		name = "roguef",
		order = "g",
