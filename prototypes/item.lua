...
function weapon(name, cooldown, range, sound)
	if sound == nil then sound = make_light_gunshot_sounds() end
	...
	return {
		...
		icon = "__m-roguef__/graphics/icons/weapon/" .. name .. ".png",
		icon_size = 32,
		flags = {},
		subgroup = "rf_weapon",
		order = "a",
	...
	{ -- weapon 21,1,30 --78
		...
		attack_parameters = {
			...
			cyclic_sound = {
				...
				middle_sound = {{filename = "__m-roguef__/sound/shot-21.ogg", volume = 0.5}},
