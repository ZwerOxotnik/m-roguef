...
data:extend({
	...
	pollution_absorption_per_second = 0,
		...
		variants =
		{
			...
			{
				{
					picture = "__m-roguef__/graphics/terrain/water/water1.png",
					count = 8,
					size = 1
				},
				{
					picture = "__m-roguef__/graphics/terrain/water/water2.png",
					count = 8,
					size = 2
				},
				{
					picture = "__m-roguef__/graphics/terrain/water/water4.png",
					count = 6,
					size = 4
				}
			},
			inner_corner =
			{
				picture = "__m-roguef__/graphics/terrain/water/water-inner-corner.png",
				count = 6
			},
			outer_corner =
			{
				picture = "__m-roguef__/graphics/terrain/water/water-outer-corner.png",
				count = 6
			},
			side =
			{
				picture = "__m-roguef__/graphics/terrain/water/water-side.png",
				count = 8
			}
		},
